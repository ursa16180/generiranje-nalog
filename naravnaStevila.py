...
class DolociStevko(Naloga):  # TODO besedilo za 2 delitelja
    def __init__(self, lazja=True, **kwargs):
        super().__init__(self, **kwargs)
        self.besedilo_posamezne = jinja2.Template(
            r'''Za katero števko $a$ število ${{naloga.delitelj1}}$ deli ${{naloga.stevilo}}$ deljivo?''')
    ...
    def poskusi_sestaviti(self):
        ...
        if self.lazja:
            zamenjaj1 = random.randint(2, dolzina - 3)
        ...
        print(stevke, delitelj1, delitelj2, resitev)
